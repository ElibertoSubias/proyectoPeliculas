...
export default function EnCartelera({cambiarOpcion, movies, cargarPagina, pageable, numPages, isActive, isActiveLoading, ocultarCargando, mostrarCargando}) {

    useEffect(() => {
        cambiarOpcion("encartelera");
    }, []);
